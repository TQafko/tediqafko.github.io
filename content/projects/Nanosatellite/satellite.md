...
">
  ...
  <div style="flex: 1 1 30%; text-align: center; display: flex; flex-direction: column;">
    ...
    <img src="/img/nanosat/solar-charger-3d.png" 
         style="margin-top: auto; max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 30%; text-align: center; display: flex; flex-direction: column;">
    <p><strong>Layout (Solar Charger)</strong></p>
    <img src="/img/nanosat/solar-charger-layout.png" 
         style="margin-top: auto; max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 30%; text-align: center; display: flex; flex-direction: column;">
    <p><strong>Schematic (Solar Charger)</strong></p>
    <img src="/img/nanosat/solar-charger-schematic.png" 
         style="margin-top: auto; max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 45%; text-align: center; display: flex; flex-direction: column;">
    <p><strong>3D Model (STM32 Board)</strong></p>
    <img src="/img/nanosat/proto-board.png" 
         style="margin-top: auto; max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 45%; text-align: center; display: flex; flex-direction: column;">
    <p><strong>Layout (STM32 Board)</strong></p>
    <img src="/img/nanosat/proto-board-layout.png" 
         style="margin-top: auto; max-width: 100%; height: auto; border-radius: 6px;">
  </div>
