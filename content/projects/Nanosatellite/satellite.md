...
image = "/http://tediqafko.com/img/nanosat/sat.png"
+++
...
<img src="/http://tediqafko.com/img/nanosat/sat.png" width="80%">
...
<img src="/http://tediqafko.com/img/nanosat/sat.jpg" width="80%">
...
<div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center;">
  ...
  <div style="flex: 1 1 30%; text-align: center;">
    ...
    <img src="/http://tediqafko.com/img/nanosat/solar-charger-3d.png" alt="Image 1" style="max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 30%; text-align: center;">
    <p><strong> Layout (Solar Charger)</strong></p>
    <img src="/http://tediqafko.com/img/nanosat/solar-charger-layout.png" alt="Image 2" style="max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 30%; text-align: center;">
    <p><strong>Schematic (Solar Charger)</strong></p>
    <img src="/http://tediqafko.com/img/nanosat/solar-charger-schematic.png" alt="Image 3" style="max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 45%; text-align: center;">
    <p><strong>3D Model (STM32 Board)</strong></p>
    <img src="/http://tediqafko.com/img/nanosat/proto-board.png" alt="Image 4" style="max-width: 100%; height: auto; border-radius: 6px;">
  </div>

  <div style="flex: 1 1 45%; text-align: center;">
    <p><strong>Layout (STM32 Board)</strong></p>
    <img src="/http://tediqafko.com/img/nanosat/proto-board-layout.png" alt="Image 5" style="max-width: 100%; height: auto; border-radius: 6px;">
  </div>
...
<embed src="/http://tediqafko.com/img/nanosat/pico-eps.pdf" type="application/pdf" width="100%" height="600px" title="Embedded PDF Viewer" />